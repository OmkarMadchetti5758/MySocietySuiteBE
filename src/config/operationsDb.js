...
const connectOperationsDB = async () => {
    ...
    try {
        ...
        // Ledger Management
        const ledgerModels = require("../modules/ledger/ledger.model");
        opsConnection.model("ChartOfAccount", ledgerModels.chartOfAccountSchema);
        opsConnection.model("AccountingPeriod", ledgerModels.accountingPeriodSchema);
        opsConnection.model("JournalEntry", ledgerModels.journalEntrySchema);
        opsConnection.model("JournalEntryLine", ledgerModels.journalEntryLineSchema);
        opsConnection.model("LedgerAuditLog", ledgerModels.ledgerAuditLogSchema);
